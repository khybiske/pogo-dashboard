...
const ALL_SHEETS = [
  ...
  'PVPRosterUL','PVPMetaUL','Medals','UpcomingCDs','UsefulLinks'
];
...
function renderAll() {
  for (const [fn, name] of [[renderEvents,'Events'],[renderRaidBosses,'Raids'],[renderPowerUp,'PowerUp'],[renderWhoMax,'WhoMax'],[renderCandy,'Candy'],[renderTrades,'Trades'],[renderMissingRareShinies,'MissingRare'],[renderHotShinies,'HotShinies'],[renderPVP,'PVP'],[renderShinyOdds,'ShinyOdds'],[renderMedals,'Medals'],[renderUpcomingCDs,'UpcomingCDs'],[renderLinks,'Links']]) {
