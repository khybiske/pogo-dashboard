...
function renderPVP() {
  ...
  c.innerHTML = sorted.map(({r, idx}) => {
    ...
    const readyLabel = ready
      ...
      : '<span style="background:#FED7D7;color:#C53030;font-size:10px;padding:1px 5px;border-radius:4px;font-weight:600;">⚔️</span>';
    const ivRankBadge = ivRank
      ? `<span style="background:#2b6cb0;color:white;font-size:10px;padding:1px 6px;border-radius:10px;font-weight:600;">${ivRank}</span>`
      : '';
