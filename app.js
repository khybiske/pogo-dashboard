...
const ALL_SHEETS = [
  ...
  'PVPRosterUL','PVPMetaUL','Medals','UpcomingCDs','UsefulLinks','EventChecklist','SpecialEvents'
];
...
function renderAll() {
  for (const [fn, name] of [[renderEvents,'Events'],[renderRaidBosses,'Raids'],[renderPowerUp,'PowerUp'],[renderWhoMax,'WhoMax'],[renderCandy,'Candy'],[renderTrades,'Trades'],[renderMissingRareShinies,'MissingRare'],[renderHotShinies,'HotShinies'],[renderPVP,'PVP'],[renderShinyOdds,'ShinyOdds'],[renderMedals,'Medals'],[renderUpcomingCDs,'UpcomingCDs'],[renderLinks,'Links'],[renderEventChecklist,'EventChecklist'],[renderSpecialEventLinks,'SpecialEvents']]) {
...
function renderCandy() {
  ...
  for (const r of candidates) {
    ...
    const rareCandyPart = needRC > 0
      ? `<span style="color:#C05621;font-weight:700;">${needRC}${RC}</span>` : '';
