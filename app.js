...
async function confirmShinyCaught(idx, evt) {
  ...
  renderMissingRareShinies();
  setBgSaving(true);
  await saveSheetData('ShinyCollection', [['Pokemon','Have','Priority','CD','Evolved','Legendary'], ...shinyGapsData]);
  setBgSaving(false);
...
function renderMissingRareShinies() {
  ...
  // Column indices: 0=Pokemon, 1=Have, 2=Priority, 3=CD, 4=Evolved, 5=Legendary
