...
function sprite(name, regional, form, shiny) {
  ...
  const cacheKey = `pokemon_data_${apiSlug}`;
...
// ── Medal Progress ─────────────────────────────────────────────────────────────
const MEDAL_HEADERS = ['Medal','Current','Bronze','Silver','Gold','Platinum'];
  ...
  c.innerHTML = active.map(({ r, idx }) => {
    ...
    <div class="medal-card">
      ...
      <div style="display:flex;justify-content:space-between;margin-top:5px;font-size:10px;color:#999;">
        <span style="color:${nextColor};font-weight:600;">▲ ${remaining.toLocaleString()} to ${nextLabel}</span>
