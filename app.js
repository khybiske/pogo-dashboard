...
// ── Raid Boss Tracker ─────────────────────────────────────────────────────────
const RAID_HEADERS = ['Pokemon','Tier','Shiny','IVs','XL','Dex','Costume','Priority','Notes','Done','DoneDate','Remote'];
  ...
  c.innerHTML = `<div style="display:flex;flex-wrap:wrap;gap:10px;">
    ${sorted.map(({r,idx}) => {
      ...
      <div style="position:relative;display:flex;flex-direction:column;align-items:center;
                  width:90px;background:white;border-radius:10px;padding:${(done||isRemote)?'18px 6px 6px':'10px 6px 6px'};
