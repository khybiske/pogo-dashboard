...
// META-RELEVANT Pokemon Types (~100 most used in raids/gyms)
const POKEMON_TYPES = {
  // Fire Meta
  'reshiram':'Dragon,Fire','charizard':'Fire,Flying','blaziken':'Fire,Fighting',
  'chandelure':'Ghost,Fire','heatran':'Fire,Steel','entei':'Fire','moltres':'Fire,Flying',
  'darmanitan':'Fire','volcarona':'Bug,Fire',
  // Water Meta
  'kyogre':'Water','swampert':'Water,Ground','kingler':'Water','gyarados':'Water,Flying',
  'samurott':'Water','empoleon':'Water,Steel','feraligatr':'Water',
  // Grass Meta
  'kartana':'Grass,Steel','zarude':'Dark,Grass','roserade':'Grass,Poison',
  'venusaur':'Grass,Poison','sceptile':'Grass','tangrowth':'Grass','torterra':'Grass,Ground',
  // Electric Meta
  'zekrom':'Dragon,Electric','xurkitree':'Electric','electivire':'Electric',
  'magnezone':'Electric,Steel','luxray':'Electric','raikou':'Electric','zapdos':'Electric,Flying',
  // Ice Meta
  'mamoswine':'Ice,Ground','glaceon':'Ice','weavile':'Dark,Ice','kyurem':'Dragon,Ice',
  'articuno':'Ice,Flying','avalugg':'Ice',
  // Fighting Meta
  'terrakion':'Rock,Fighting','lucario':'Fighting,Steel','machamp':'Fighting',
  'conkeldurr':'Fighting','breloom':'Grass,Fighting','hariyama':'Fighting',
  // Poison Meta
  'nihilego':'Rock,Poison','gengar':'Ghost,Poison','toxicroak':'Poison,Fighting','crobat':'Poison,Flying',
  // Ground Meta
  'groudon':'Ground','garchomp':'Dragon,Ground','rhyperior':'Ground,Rock',
  'landorus':'Ground,Flying','excadrill':'Ground,Steel',
  // Flying Meta
  'rayquaza':'Dragon,Flying','honchkrow':'Dark,Flying','staraptor':'Normal,Flying',
  'tornadus':'Flying','yveltal':'Dark,Flying',
  // Psychic Meta
  'mewtwo':'Psychic','latios':'Dragon,Psychic','latias':'Dragon,Psychic',
  'espeon':'Psychic','alakazam':'Psychic','metagross':'Steel,Psychic',
  // Bug Meta
  'pheromosa':'Bug,Fighting','genesect':'Bug,Steel','scizor':'Bug,Steel',
  'vikavolt':'Bug,Electric','heracross':'Bug,Fighting',
  // Rock Meta
  'rampardos':'Rock','tyranitar':'Rock,Dark','gigalith':'Rock','aggron':'Steel,Rock',
  // Ghost Meta
  'giratina':'Ghost,Dragon','banette':'Ghost','mismagius':'Ghost','drifblim':'Ghost,Flying',
  // Dragon Meta
  'salamence':'Dragon,Flying','dragonite':'Dragon,Flying','dialga':'Steel,Dragon',
  'palkia':'Water,Dragon','hydreigon':'Dark,Dragon','haxorus':'Dragon',
  // Dark Meta
  'darkrai':'Dark','zoroark':'Dark','umbreon':'Dark',
  // Fairy Meta
  'gardevoir':'Psychic,Fairy','togekiss':'Fairy,Flying','sylveon':'Fairy',
  'xerneas':'Fairy','primarina':'Water,Fairy','azumarill':'Water,Fairy',
  // Defenders & Gym
  'slaking':'Normal','blissey':'Normal','snorlax':'Normal',
  // Eevee line
  'vaporeon':'Water','jolteon':'Electric','flareon':'Fire','leafeon':'Grass',
  // Popular starters
  'bulbasaur':'Grass,Poison','ivysaur':'Grass,Poison',
  ...
  'totodile':'Water','croconaw':'Water',
  'treecko':'Grass','grovyle':'Grass',
  'torchic':'Fire','combusken':'Fire,Fighting',
  'mudkip':'Water','marshtomp':'Water,Ground',
  'turtwig':'Grass','grotle':'Grass',
  ...
  'oshawott':'Water','dewott':'Water',
  // Other popular
  'eevee':'Normal','dratini':'Dragon','dragonair':'Dragon','magikarp':'Water',
  'larvitar':'Rock,Ground','pupitar':'Rock,Ground','beldum':'Steel,Psychic',
  'metang':'Steel,Psychic','gible':'Dragon,Ground','gabite':'Dragon,Ground',
...
// HYBRID TYPE AUTO-FILL: Local DB first, PokeAPI fallback
async function autoFillTypes() {
  const nameInput = document.getElementById('puPokemon').value.toLowerCase().trim();
  ...
  const cleanName = nameInput.replace(/^(alolan|galarian|hisuian|shadow|mega|primal) /,'');
  
  // Try local database first (instant for meta Pokemon)
  if (POKEMON_TYPES[cleanName]) {
    typeField.value = POKEMON_TYPES[cleanName];
    autoInfo.textContent = '✓ Types auto-filled';
    autoInfo.style.color = '#48BB78';
    return;
  }
  
  // Fallback to PokeAPI for unknown Pokemon
  ...
  try {
    ...
    autoInfo.textContent = '⚠️ Pokemon not found - enter types manually';
