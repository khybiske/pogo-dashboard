...
// Added: Sprite preview in modal + detailed console logging for debugging
...
async function handleSpriteError(img, pokemonName) {
  console.log(`[Sprite Error] Failed to load sprite for: ${pokemonName}`);
  
  // Prevent infinite loops
  if (img.dataset.fallbackAttempted) {
    console.log(`[Sprite Error] Already attempted fallback for ${pokemonName}, using Pikachu`);
  ...
  console.log(`[Sprite Error] Attempting PokeAPI lookup for: ${pokemonName}`);
  ...
  if (data && data.sprite) {
    ...
    console.log(`[Sprite Error] No sprite found for ${pokemonName}, using Pikachu fallback`);
