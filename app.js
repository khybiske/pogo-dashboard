...
const DEFAULT_ORDER = ['events','raids','powerup','whomax','candy','lucky','shinygaps','shinyodds','pvp','medals','links'];
...
async function loadAllData() {
  ...
  const results = await Promise.all(ALL_SHEETS.map(safe));
...
function renderAll() {
  for (const [fn, name] of [[renderEvents,'Events'],[renderRaidBosses,'Raids'],[renderPowerUp,'PowerUp'],[renderWhoMax,'WhoMax'],[renderCandy,'Candy'],[renderTrades,'Trades'],[renderShinyGaps,'Shinies'],[renderPVP,'PVP'],[renderShinyOdds,'ShinyOdds'],[renderMedals,'Medals'],[renderUpcomingCDs,'UpcomingCDs'],[renderLinks,'Links']]) {
